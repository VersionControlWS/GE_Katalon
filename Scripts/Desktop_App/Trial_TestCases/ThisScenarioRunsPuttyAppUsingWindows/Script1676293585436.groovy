...
Windows.click(findWindowsObject('Object Repository/DesktopApps/DesktopApp_Putty/HostName_TextField'))

Windows.setText(findWindowsObject('Object Repository/DesktopApps/DesktopApp_Putty/HostName_TextField'), '34.27.230.36')

Windows.click(findWindowsObject('Object Repository/DesktopApps/DesktopApp_Putty/OpenButton_SystemGenerated'))

Thread.sleep(6000)

//Windows.switchToWindow(findWindowsObject('Object Repository/DesktopApps/DesktopApp_Putty/Putty_Window'))
...
//Thread.sleep(6000)
//
//Windows.sendKeys(findWindowsObject("Object Repository/DesktopApps/DesktopApp_Putty/Putty_Window"), 'UTH_offshore')
