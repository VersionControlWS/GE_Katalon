...
//CustomKeywords.
output = CustomKeywords.'verify.Element.stringToastElementPresent'(findTestObject('Object Repository/Login_Module/GTPT_LoginInvalid_TC_0007/Popup_Text/Page_GIROPie/div_Please enter a valid email address'))
CustomKeywords.'verify.Element.stringToastElementText'(findTestObject('Object Repository/Login_Module/GTPT_LoginInvalid_TC_0007/Popup_Text/Page_GIROPie/div_Please enter a valid email address'), output)
