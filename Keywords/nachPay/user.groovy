...
public class user {
	...
	def LoginwithUsernamePwd() {
		...
		WebUI.callTestCase(findTestCase('TC0001_GP_PT_Login'), [('url') : url, ('username') : username, ('password') : password],
	...
	def ClickonDeleteAndYesinBankPage() {
		WebUI.click(findTestObject('Object Repository/BankPageDeleteButton/Delete_button_in_BankPage'))
		WebUI.click(findTestObject('Object Repository/BankPageDeleteButton/button_Yes'))
	}
